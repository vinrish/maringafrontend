...
const { data: feeNoteData, execute: fetchFeeNotes } = await useApi<any>(createUrl('/summary-companies-fee', {
  query: {
    q: searchQuery,
      ...
      >
        ...
        <template #item.company_name="{ item }">
          <div class="d-flex flex-column">
            <h6 class="text-base">
              <RouterLink
                :to="{ name: 'fee-notes-summary-company-details-id', params: { id: item.company_id } }"
        ...
        <template #item.actions="{ item }">
          ...
          >
            ...
            <VMenu activator="parent">
              <VList>
                <VListItem :to="{ name: 'fee-notes-summary-company-details-id', params: { id: item.company_id } }">
                  <template #prepend>
